...
public class SQLSourceHelper {
	...
	private String schedule, customQueryId;
	...
	public SQLSourceHelper(Context context, String sourceName){
        ...
        schedule = context.getString("schedule", "0 0/5 * * * ?");
		customQueryId = context.getString("custom.query.id", "ID");
	...
	public String getCustomQueryId() { return customQueryId; }
