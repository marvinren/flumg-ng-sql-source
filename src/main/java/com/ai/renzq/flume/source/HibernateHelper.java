...
public class HibernateHelper {
	...
	public List<Map<String, Object>> executeQueryJsonRes() throws InterruptedException{
		...
		if (!rowsList.isEmpty()){
			if (sqlSourceHelper.isCustomQuerySet()){
				sqlSourceHelper.setCurrentIndex(rowsList.get(rowsList.size()-1).get(sqlSourceHelper.getCustomQueryId()).toString());
			}
			else
			{
